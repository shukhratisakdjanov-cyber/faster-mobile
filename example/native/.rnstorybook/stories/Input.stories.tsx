...
const meta = {
  ...
  argTypes: {
    ...
    disabled: { control: 'boolean' }, clearable: { control: 'boolean' }, passwordToggle: { control: 'boolean' },
...
export const Introduction: Story = { render: () => <StoryIntroduction title="Input">Input is a controlled native TextInput wrapper with label, helper, error, disabled, clearable, and password-visibility states. It forwards standard TextInput props, and error text is announced politely.</StoryIntroduction> };
...
export const Password: Story = { render: () => <StoryScreen><ControlledInput label="Password" secureTextEntry passwordToggle helperText="Use at least 12 characters." /></StoryScreen> };
